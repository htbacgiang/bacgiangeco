    ...
    <>
      ...
      >
        ...
        <ul>
          ...
          <a> <Link to={`/album`}> Sản phẩm </Link> </a>
            <label for="btn-1"> <BiChevronDown size={30} className="ml-2"  /> </label>
          </div>
            <input className='input' type="checkbox" id="btn-1"/>
            <ul>
                       <li><a> <Link to={`/album/ha-tay-que-lua`}> Rau củ quả </Link> </a></li>
                       <li><a> <Link to={`/album/truong-va-nhung-nguoi-ban`}> Rau gia vị </Link> </a></li>
            </ul>
          </li>
          <li><a> <Link to={`/blog`}> Chuyện của Farm </Link> </a></li>
